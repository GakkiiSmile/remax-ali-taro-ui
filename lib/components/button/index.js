...
import { Button, View } from "remax/ali";
...
export default class AtButton extends React.Component {
    ...
    render() {
        const { size = "normal", type = "", circle, full, loading, disabled, customStyle, formType, lang, sessionFrom, sendMessageTitle, sendMessagePath, sendMessageImg, showMessageCard, appParameter, } = this.props;
        ...
        const button = (React.createElement(Button, { className: "at-button__wxbutton", formType: formType, 
            // @ts-ignore
